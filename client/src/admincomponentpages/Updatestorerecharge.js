...
const Updatestorerecharge = () => {
    ...
    const fillinput = () => {
        axios.get(`http://localhost:5000/selectupdatestoreplan/${param.id}`).then((response) => {
    ...
    const updateplan = () => {
        axios.put(`http://localhost:5000/updatestoreplan/${param.id}`, {
    ...
    return (
        <div className='updateuserrecharge'>
            <h1 className='heading'>Updatestorerecharge</h1><br /><br />
...
export default Updatestorerecharge;