...
const Updatestoresalesrecharge = () => {
    ...
    const fillinput = () => {
        axios.get(`http://localhost:5000/selectupdatestoresalesplan/${param.id}`).then((response) => {
    ...
    const updateplan = () => {
        axios.put(`http://localhost:5000/updatestoresalesplan/${param.id}`, {
    ...
    return (
        <div className='updateuserrecharge'>
            <h1 className='heading'>Updatestoresalesrecharge</h1><br /><br /><br />
...
export default Updatestoresalesrecharge;